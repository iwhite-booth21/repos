...
namespace DataBaseManageSystemTEMP1 {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow AddTableRow(string First_Name, string Last_Name, string PhoneNumber, decimal Salary) {
...
namespace DataBaseManageSystemTEMP1.DataSet1TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([First Name] = @Original_First_Name) AND ([Last" +
                " Name] = @Original_Last_Name) AND ([PhoneNumber] = @Original_PhoneNumber) AND ([" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([First Name], [Last Name], [PhoneNumber], [Salary]) VA" +
                "LUES (@First_Name, @Last_Name, @PhoneNumber, @Salary);\r\nSELECT [First Name], [La" +
                "st Name], PhoneNumber, Salary FROM [Table] WHERE ([First Name] = @First_Name)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [First Name] = @First_Name, [Last Name] = @Last_Name, [PhoneNumber] = @PhoneNumber, [Salary] = @Salary WHERE (([First Name] = @Original_First_Name) AND ([Last Name] = @Original_Last_Name) AND ([PhoneNumber] = @Original_PhoneNumber) AND ([Salary] = @Original_Salary));
SELECT [First Name], [Last Name], PhoneNumber, Salary FROM [Table] WHERE ([First Name] = @First_Name)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DataBaseManageSystemTEMP1.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [First Name], [Last Name], PhoneNumber, Salary FROM dbo.[Table]";
        ...
        public virtual int Delete(string Original_First_Name, string Original_Last_Name, string Original_PhoneNumber, decimal Original_Salary) {
        ...
        public virtual int Insert(string First_Name, string Last_Name, string PhoneNumber, decimal Salary) {
            if ((First_Name == null)) {
        ...
        public virtual int Update(string First_Name, string Last_Name, string PhoneNumber, decimal Salary, string Original_First_Name, string Original_Last_Name, string Original_PhoneNumber, decimal Original_Salary) {
            if ((First_Name == null)) {
                throw new global::System.ArgumentNullException("First_Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Last_Name, string PhoneNumber, decimal Salary, string Original_First_Name, string Original_Last_Name, string Original_PhoneNumber, decimal Original_Salary) {
            return this.Update(Original_First_Name, Last_Name, PhoneNumber, Salary, Original_First_Name, Original_Last_Name, Original_PhoneNumber, Original_Salary);
        }
    }
